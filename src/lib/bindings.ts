...
export const commands = {
  async listGitStatus(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_git_status', { workspacePath })
      }
    } catch (e) {
  ...
  async listWorkspaceFiles(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_workspace_files', {
          workspacePath,
          maxDepth
        })
      }
  ...
  async updateWorkspace(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_workspace', { id, avatarStyle })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async unlockAchievement(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('unlock_achievement', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async compactConversation(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('compact_conversation', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async checkProviderReady(
    profileId: string
  ): Promise<Result<ProviderReadyInfo, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('check_provider_ready', { profileId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getArtifactContent(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_artifact_content', { artifactId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async setBuiltInTheme(themeName: string): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_built_in_theme', { themeName })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async setThemeFromFile(path: string): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_theme_from_file', { path })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getConversationBootstrap(
    conversationId: string
  ): Promise<Result<ConversationBootstrapData, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_conversation_bootstrap', {
          conversationId
        })
      }
    } catch (e) {
  ...
  async pinArtifact(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('pin_artifact', {
          artifactId,
          branchId,
          isGlobal
        })
  ...
  async unpinArtifact(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('unpin_artifact', { artifactId, branchId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async listPinnedArtifacts(
    conversationId: string,
    branchId: string | null
  ): Promise<Result<ArtifactData[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_pinned_artifacts', {
          conversationId,
          branchId
        })
      }
  ...
  async listArtifactVersions(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_artifact_versions', { artifactId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async copyArtifactToBranch(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('copy_artifact_to_branch', {
          artifactId,
          targetBranchId
        })
      }
  ...
  async listArtifacts(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_artifacts', { conversationId, branchId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getConversationDraft(
    conversationId: string
  ): Promise<Result<[string, JsonValue[]] | null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_conversation_draft', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async upsertConversationDraft(
    ...
    contextItems: JsonValue[] | null
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('upsert_conversation_draft', {
          conversationId,
          textContent,
          contextItems
        })
  ...
  async attachFilesToConversation(
    conversationId: string,
    paths: string[]
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('attach_files_to_conversation', {
          conversationId,
          paths
        })
      }
  ...
  async renameFolder(id: string, name: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('rename_folder', { id, name })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async moveConversationToFolder(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('move_conversation_to_folder', {
          conversationId,
          folderId
        })
      }
   ...
   */
  async setAutoApproveConfig(
    config: AutoApproveConfigDto
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_auto_approve_config', { config })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<BookmarkData, string>> {
    try {
  ...
  async removeBookmark(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('remove_bookmark', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async listBookmarks(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_bookmarks', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async toggleBookmark(
    ...
    label: string | null
  ): Promise<Result<BookmarkData | null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('toggle_bookmark', {
          conversationId,
          messageId,
          headingAnchor,
          label
  ...
  async processQueuedMessages(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('process_queued_messages', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async setAutoSendPaused(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_auto_send_paused', {
          conversationId,
          paused
        })
      }
  ...
  async createBranch(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('create_branch', { req })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async listBranches(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_branches', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getBranchMessages(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_branch_messages', { branchId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<WorkflowDefinitionResponse, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('save_workflow_definition', { req })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async listWorkflowDefinitions(): Promise<
    Result<WorkflowDefinitionResponse[], string>
  > {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_workflow_definitions')
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getWorkflowDefinition(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_workflow_definition', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async deleteWorkflowDefinition(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_workflow_definition', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async updateWorkflowDefinition(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_workflow_definition', {
          id,
          name,
          definition
        })
  ...
  async runWorkflowDefinition(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('run_workflow_definition', { id, providerId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getInstalledSkillContent(
    skillName: string,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_installed_skill_content', {
          skillName,
          target
        })
      }
  ...
  async getInstalledSkillPath(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_installed_skill_path', {
          skillName,
          target
        })
      }
  ...
  async installRegistrySkill(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('install_registry_skill', {
          skillId,
          target,
          overwrite
        })
  ...
  async fetchRegistrySkills(
    ...
    search: string | null
  ): Promise<Result<RegistrySkillData[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('fetch_registry_skills', { category, search })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async createConversation(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('create_conversation', {
          profileId,
          title,
          workspaceId
        })
  ...
  async listConversations(
    ...
    limit: string | null
  ): Promise<Result<ConversationSummary[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_conversations', { profileId, limit })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async deleteConversation(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_conversation', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async renameConversation(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('rename_conversation', { id, title })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async listMessages(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_messages', { conversationId, branchId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<SearchMessagesResult[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('search_messages', { req })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async markMessageSeen(messageId: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('mark_message_seen', { messageId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async resolveToolApproval(
    toolCallId: string,
    approved: boolean,
    editedInput: JsonValue | null
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('resolve_tool_approval', {
          toolCallId,
          approved,
          editedInput
        })
  ...
  ): Promise<Result<ProfileData[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_profiles', { includeDeleted })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async updateProfile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_profile', {
          id,
          name,
          modelProvider,
          modelId,
  ...
  async deleteProfile(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_profile', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async setDefaultProfile(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_default_profile', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async restoreProfile(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('restore_profile', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async setApiKey(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_api_key', { provider, key })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async deleteApiKey(provider: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_api_key', { provider })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async toggleSkill(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('toggle_skill', { name, active })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<LintWarning[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('lint_skill', { path, workspaceConfigPath })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async lintAllLocalSources(): Promise<
    Result<Partial<{ [key in string]: LintWarning[] }>, string>
  > {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('lint_all_local_sources')
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async disableLintRule(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('disable_lint_rule', { ruleId, scope })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async installSkill(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('install_skill', {
          skillName,
          skillContent,
          target,
          overwrite
  ...
  async uninstallSkill(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('uninstall_skill', { skillName, target })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<DiffResult, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('diff_skill_versions', {
          localPath,
          registryContent
        })
      }
  ...
  async addSkillSource(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('add_skill_source', {
          sourceType,
          path,
          label
        })
  ...
  async removeSkillSource(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('remove_skill_source', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async connectMcpServer(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('connect_mcp_server', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async disconnectMcpServer(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('disconnect_mcp_server', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async addMcpServer(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('add_mcp_server', { payload })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async removeMcpServer(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('remove_mcp_server', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async exportConversation(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('export_conversation', { id, format, path })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async shareSkillAsGist(
    skillName: string,
    contentMd: string,
    description: string
  ): Promise<Result<GistInfo, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('share_skill_as_gist', {
          skillName,
          contentMd,
          description
        })
  ...
  async shareWorkflowAsGist(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('share_workflow_as_gist', {
          workflowName,
          workflowJson,
          description
        })
  ...
  async importSkillFromGist(gistId: string): Promise<Result<GistFile, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('import_skill_from_gist', { gistId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async importWorkflowFromGist(
    gistId: string
  ): Promise<Result<JsonValue, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('import_workflow_from_gist', { gistId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async exportConversationAsMarkdown(
    title: string,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('export_conversation_as_markdown', {
          title,
          messages,
          tags
        })
  ...
  async setGithubToken(token: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('set_github_token', { token })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async openWorkspace(path: string): Promise<Result<WorkspaceData, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('open_workspace', { path })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async closeWorkspace(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('close_workspace', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async ensurePlatformRegistration(): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('ensure_platform_registration')
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getPlatformPreferences(): Promise<Result<PlatformPreferences, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_platform_preferences')
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  ): Promise<Result<PlatformPreferences, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_platform_preferences', { payload })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async sendActivityEvent(
    payload: ActivityEventRequest
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('send_activity_event', { payload })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async resendVerificationEmail(): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('resend_verification_email')
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async deletePlatformAccount(): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_platform_account')
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async getSharedConversation(
    shareToken: string
  ): Promise<Result<SharedConversationPayload, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_shared_conversation', { shareToken })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async checkSyncStatus(
    conversationId: string
  ): Promise<Result<SyncStatusResponse, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('check_sync_status', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async shareConversation(
    conversationId: string
  ): Promise<Result<ShareResponse, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('share_conversation', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async syncConversationToPlatform(
    conversationId: string,
    payload: SyncConversationRequest
  ): Promise<Result<SyncConversationResponse, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('sync_conversation_to_platform', {
          conversationId,
          payload
        })
      }
  ...
  async hydrateSharedConversation(
    payload: SharedConversationPayload
  ): Promise<Result<HydrateResponse, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('hydrate_shared_conversation', { payload })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async cancelAgent(conversationId: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('cancel_agent', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async testApiConnection(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('test_api_connection', { provider, key })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async listDirectoryContents(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_directory_contents', { path })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async countFolderFiles(path: string): Promise<Result<FolderCounts, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('count_folder_files', { path })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async readFile(
    req: ReadFileRequest
  ): Promise<Result<ReadFileResponse, string>> {
    try {
  ...
  async assembleFolder(
    req: AssembleFolderRequest
  ): Promise<Result<AssembleFolderResponse, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('assemble_folder', { req })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async addQueuedMessage(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('add_queued_message', { req })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async listQueuedMessages(
    conversationId: string
  ): Promise<Result<QueuedMessage[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('list_queued_messages', { conversationId })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async updateQueuedMessage(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_queued_message', { id, content })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async deleteQueuedMessage(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('delete_queued_message', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async reorderQueuedMessages(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('reorder_queued_messages', {
          conversationId,
          orderedIds
        })
      }
  ...
  async mergeQueuedMessages(ids: string[]): Promise<Result<string, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('merge_queued_messages', { ids })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async pinConversation(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('pin_conversation', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
  ...
  async unpinConversation(id: string): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('unpin_conversation', { id })
      }
    } catch (e) {
      if (e instanceof Error) throw e
      else return { status: 'error', error: e as any }
   ...
   */
  async updateConversationWorkspace(
    id: string,
    workspaceId: string | null
  ): Promise<Result<null, string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('update_conversation_workspace', {
          id,
          workspaceId
        })
      }
  ...
  async getConversationMessagesHeadings(
    conversationId: string
  ): Promise<Result<HeadingItem[], string>> {
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('get_conversation_messages_headings', {
          conversationId
        })
      }
    } catch (e) {
  ...
  async writeArtifactToFile(
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('write_artifact_to_file', {
          artifactId,
          targetPath
        })
      }
  ...
  async runCodeSnippet(
    channel: TAURI_CHANNEL<RunOutput>,
    language: string,
    code: string,
    ...
    try {
      return {
        status: 'ok',
        data: await TAURI_INVOKE('run_code_snippet', {
          channel,
          language,
          code,
          workingDir
...
export type AddQueuedMessageRequest = {
...
export type AgentEvent =
  ...
  | {
      type: 'thinking_stream_update'
      conversation_id: string
      document: NodeDocument
    }
  | { type: 'thinking_done'; conversation_id: string; document: NodeDocument }
...
export type AssembleFolderRequest = {
  path: string
  deep: boolean
  max_bytes: string | null
}
export type AssembleFolderResponse = {
  assembled_content: string
  file_count: string
}
export type AutoApproveConfigDto = {
  auto_approve_reads: boolean
  auto_approve_writes: boolean
  auto_approve_shell: boolean
  auto_approve_http_requests: boolean
  auto_approve_selects: boolean
...
export type McpEvent =
  | { type: 'server_connected'; name: string }
  | { type: 'server_disconnected'; name: string }
  | { type: 'server_failed'; name: string; message: string }
  | { type: 'tool_discovered'; server: string; tool: McpToolInfo }
...
export type MdNode =
  ...
  | { type: 'html_block'; id: string; html: string }
/**
...
export type MessageData = {
  ...
  thinking_document: NodeDocument | null
}
/**
...
export type ProviderReadyInfo = {
  profile_id: string
  status: ProviderReadyStatus
}
export type ProviderReadyStatus =
  | { status: 'ready' }
  | { status: 'not_ready'; reason: string; fix_action: string }
...
export type RunCodeEvent =
  | { type: 'stdout'; run_id: string; line: string }
  | { type: 'stderr'; run_id: string; line: string }
  | { type: 'exit'; run_id: string; code: number; elapsed_ms: string }
export type RunOutput =
  | { type: 'stdout'; line: string }
  | { type: 'stderr'; line: string }
  | { type: 'exit'; code: number; elapsed_ms: string }
