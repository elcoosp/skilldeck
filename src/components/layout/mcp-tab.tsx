  ...
  if (view === 'catalog') {
    return (
      <div className="flex flex-col h-full overflow-hidden">
        {/* Header */}
        <div className="flex items-center gap-2 px-2.5 pt-2.5 pb-2 border-b border-border shrink-0 min-w-0 overflow-hidden">
          <button
            type="button"
          ...
          >
            All <ExternalLink className="size-2.5" />
          </button>
        </div>
          ...
          >
            {(['all', ...CATEGORY_ORDER] as const).map((cat) => (
              <button
                ...
                className={cn(
                  'shrink-0 px-2 py-0.5 rounded-full text-[10px] font-medium transition-colors',
                  catalogCategory === cat
  ...
  if (view === 'custom') {
    return (
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-2 px-2.5 pt-2.5 pb-2 border-b border-border shrink-0 min-w-0">
          <button
            type="button"
            onClick={() => setView('servers')}
            className="text-muted-foreground hover:text-foreground transition-colors shrink-0"
          ...
          <span className="text-xs font-semibold truncate">Custom Server</span>
        </div>
        ...
        <div className="px-2.5 pb-2.5 space-y-2 mt-2">
          {isLoading ? (
            ...
            >
              <img
                ...
                alt="No MCP servers"
                className="w-20 h-20 object-contain mb-3 rounded-xl opacity-90"
              />
              <h3 className="text-xs font-semibold text-foreground mb-1">
                Your agent needs friends.
              </h3>
              <p className="text-[11px] text-muted-foreground leading-relaxed px-1">
                Add an MCP server to give it new tools.
              </p>
            </motion.div>
          ) : (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[11px] font-medium truncate">Browse catalog</p>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[11px] font-medium truncate">Custom server</p>
              <p className="text-[10px] text-muted-foreground truncate">
                stdio or SSE
              </p>
            </div>
          ...
          <button
            ...
            className="flex items-center gap-1 px-0.5 pt-0.5 text-[10px] text-muted-foreground hover:text-foreground transition-colors"
          >
