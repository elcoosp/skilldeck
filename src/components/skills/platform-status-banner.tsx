...
export function PlatformStatusBanner({ variant, onEnable, onRetry }: PlatformStatusBannerProps) {
    ...
    return (
      <div className={cn(
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <span>Platform features are disabled. Connect to browse community skills.</span>
        </div>
