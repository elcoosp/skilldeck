...
- [Install an MCP server](/en/how-to/add-mcp-server/filesystem-server) to give the agent access to external tools.
- [Configure profiles](/en/how-to/configure-profiles) to switch between AI providers.
- [Share your own skill](/en/tutorials/build-a-skill/share-via-gist) with the community.
