...
export const AB_TESTS: Record<string, ABTestConfig> = {
  hero: {
    name: 'Hero Headline',
    description: 'Test problem-focused vs outcome-focused hero headline and benefit language',
    variants: [
  ...
  hero_cta: {
    ...
    variants: [
      { key: 'platform', name: 'Platform-specific (Download for macOS)', traffic: 50 },
  ...
  belt_heading: {
    ...
    variants: [
      { key: 'specific', name: 'One app replaces your AI toolchain', traffic: 50 },
      { key: 'generic', name: 'Everything you need for AI orchestration', traffic: 50 },
    ],
    startDate: '2026-04-05',
  },
  comparison_heading: {
    ...
    variants: [
      { key: 'persuasive', name: 'Why developers are switching to SkillDeck', traffic: 50 },
