...
import { Download, Github, Monitor, Laptop, Terminal } from 'lucide-react'
...
const SYSTEM_REQUIREMENTS = [
  ...
  { label: 'Network', value: 'Required for OpenAI/Claude, optional for Ollama' },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Free and open source. No account required. No cloud dependency. Works on macOS, Windows, and Linux.
            </p>
            {platform !== 'unknown' && (
              <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-blue-500/10 text-blue-500 border border-blue-500/20">
                ...
                Detected: {PLATFORMS.find((p) => p.id === platform)?.name ?? 'your platform'}
              </div>
            )}
          </div>
              ...
              return (
                <div
                  ...
                  className={`glass rounded-2xl p-6 border transition-all duration-300 h-full ${
                    isDetected ? 'border-primary/40 ring-1 ring-primary/20' : 'border-border'
                  }`}
                >
                  ...
                  <div className="space-y-2 text-sm mb-5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-foreground font-medium">{p.minVersion}</span>
                    </div>
                  </div>
                  <Button
                    className={`w-full ${
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-4">
              All releases are available on GitHub with checksums for verification.
            </p>
            <Button variant="outline" size="lg" className="border-border hover:bg-white/5 text-foreground" asChild>
              <a href="https://github.com/elcoosp/skilldeck/releases" target="_blank" rel="noopener noreferrer">
