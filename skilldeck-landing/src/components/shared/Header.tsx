...
import { Download, Github, Layers, Menu, X } from 'lucide-react'
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-between h-16">
					...
					<div className="hidden md:flex items-center gap-3">
						...
						<Button
							size="sm"
							className="bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 text-white border-0 shadow-lg shadow-blue-500/25"
						>
						...
						<SheetContent side="right" className="w-72 bg-background border-border p-0">
							...
							<div className="flex flex-col gap-6 px-6 pt-8 pb-6">
								...
								<div className="flex flex-col gap-3 mt-2">
									<Button
										className="bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 text-white border-0 w-full"
										asChild
									>
										<a href="/download">
											<Download className="w-4 h-4 mr-2" />
									...
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm text-muted-foreground hover:text-foreground transition-colors rounded-lg border border-border"
									>
