...
import { Shield, GitBranch, Puzzle } from 'lucide-react'
...
function FeatureCard({
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6 lg:p-8 hover:border-primary/20 transition-all duration-300 group h-full">
      <div className={`w-12 h-12 shrink-0 rounded-xl ${bgColor} flex items-center justify-center p-2.5 mb-5`}>
...
export function FeatureBelt() {
  ...
  const title = headingVariant === 'specific'
  ...
  const description = headingVariant === 'specific'
