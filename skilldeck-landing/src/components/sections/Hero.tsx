      ...
      <div className="rounded-xl border border-border overflow-hidden bg-card shadow-2xl shadow-blue-500/5">
        ...
        <div className="flex h-80">
          <div className="w-44 border-r border-border bg-background/50 p-3 space-y-2 shrink-0">
            ...
            <div className="px-2 py-1 text-xs text-emerald-500">
              {t('Lint passed')}
            </div>
...
export function Hero() {
  ...
  const ctaText =
    ctaVariant === 'platform' ? downloadLabel : t('Get SkillDeck Free')

  const trustBadges = [
    {
      icon: Shield,
      label: t('Local-First'),
      desc: t('All data stays on your machine')
    },
    {
      icon: Zap,
      label: t('Rust-Powered'),
      desc: t('Built with Tauri 2 for native speed')
    },
    { icon: LockOpen, label: t('Open Source'), desc: t('MIT License') },
    {
      icon: Bot,
      label: t('Multi-LLM'),
      desc: t('OpenAI, Claude, Ollama & more')
    }
  ]
